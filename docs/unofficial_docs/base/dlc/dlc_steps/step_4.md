...
!!! info "Примечание"
    ...
    Работа с mounters будет показана в тех статьях, где потребуется соответствующий маунтер, однако заранее ознакомится с общим списком mounters можно [здесь](../../../references/dlc/dlc_mounters.md)
...
На этом стартовые настройки вашего DLC можно считать завершенными. Дальнейший порядок действий завит от типа DLC и степени  влияния на основную игру.
***
Автор: lxgdark
