...
- Файл фазы квеста применяемый внутри **w2quest** или других **w2phase**. 
  Фактически - контейнер общей логики в квестовом графе
...
- Файл сущности (Entity), определяющий параметры для сущности,
  такие как внешний вид, взаимодействия, поведение и т.д.

#### **w2mesh** [CMesh]
- Файл, содержащий голую 3D модель в виде полигональной сетки. 

#### **w3app** [CEntityExternalAppearance]
- Технический файл хранящий внешний (appearance) сущности.
...
- Файлы определения маркеров для NPC или других игровых сущностей карте.
...
- Формации применяются для организации логики построения группы NPC.  
