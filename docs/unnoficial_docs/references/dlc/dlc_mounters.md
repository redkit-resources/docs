...
**taintFact** - имя факта, который "загрязняет" ваше сохранение. Проще говоря, если в сохранении будет найден такой факт, то при запуске игры из этого сохранения повторная инициализация квеста не произойдет.
